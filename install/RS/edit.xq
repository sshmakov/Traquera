...
<html>
<head>
<base href="C:/Program%20Files/Traquera3.3/data/record"/>
...
<p id="debug" style="display: visible"></p>
	<div>
                <div>
			<img src="qrc:/images/edit.png" onclick="javascript:editDescInPlace()" class="btn" width="12" height="12" title="edit"/>
			<img src="qrc:/images/filesave.png" onclick="javascript:saveDescInPlace()" class="btn" width="12" height="12" title="save"/>
			<img src="qrc:/images/cancel.png" onclick="javascript:cancelDescInPlace()" class="btn" width="12" height="12" title="cancel"/>
...
<div id="block{$i/@index}">
	...
	<img src="qrc:/images/edit.png" onclick="javascript:editNoteInPlace({$i/@index})" class="btn" width="12" height="12"/>
	<img src="qrc:/images/filesave.png" onclick="javascript:saveNoteInPlace({$i/@index})" class="btn" width="12" height="12"/>
	<img src="qrc:/images/cancel.png" onclick="javascript:cancelNoteInPlace({$i/@index})" class="btn" width="12" height="12"/>
