...
[Files]
Source: "..\tracks2.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "redistribute\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "userappdata\*"; DestDir: "{userappdata}\{code:GetAppName}"; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist uninsneveruninstall
...
[Code]
const AppName = 'TrackTasks';
const AppPublisher = 'Сергей Шмаков';
